...
class TC_GAME_API PathGenerator
{
    public:
        ...
        static Movement::PointsArray SpliceAndSmoothPath(WorldObject const* owner, const G3D::Vector3& p1, const G3D::Vector3& p2, const G3D::Vector3& p3, uint32 numPoints);
