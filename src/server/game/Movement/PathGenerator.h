...
class TC_GAME_API PathGenerator
{
    public:
        ...
        static Movement::PointsArray SpliceAndSmoothArc(WorldObject const* owner, const G3D::Vector3& A3, const G3D::Vector3& B3, const G3D::Vector3& C3, uint32 numPoints);
